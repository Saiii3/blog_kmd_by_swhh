                    ...
                    <form method="post"
                        ...
                        <div>
                            ...
                            <select id="category" name="category"
                                ...
                                <option value="media"
                                    {{ isset($post) && $post->category === 'media' ? 'selected' : '' }}>Media</option>
                                <option value="csr"
                                    {{ isset($post) && $post->category === 'csr' ? 'selected' : '' }}>CSR</option>
                            </select>
                        ...
                        <div>
                            ...
                            <x-text-input id="year" name="year" type="number" class="mt-1 block w-full"
                                :value="isset($post) ? $post->year : date('Y')" required autofocus />
