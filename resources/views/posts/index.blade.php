    ...
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{ route('posts.create') }}"
                class="bg-green-500 text-white px-4 py-2 rounded-md">{{ __('ADD') }}</a>
        </div>
    </x-slot>
                    ...
                    <table class="border-collapse table-auto w-full text-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="border-b font-medium p-4 pl-8 pt-0 pb-3 text-slate-400 text-left">Category
                                </th>
                                <th class="border-b font-medium p-4 pl-8 pt-0 pb-3 text-slate-400 text-left">Year </th>
