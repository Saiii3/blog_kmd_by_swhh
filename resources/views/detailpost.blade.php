...
<body class="font-[Poppins]">
    ...
    <div class="post-content">
        ...
        <div class="mx-auto max-w-screen-md">
            ...
            <div class="p-6">
                <h2 class="text-5xl font-semibold leading-normal mb-2">{{ $post->title }}</h2>
                <p class="text-gray-500 text-sm mb-6">Category : {{ ucfirst(strtolower($post->category)) }} | Year : {{ $post->year }}</p>
            </div>

            <img src="{{ asset('storage/' . $post->featured_image) }}" alt="Description of the image"
                class="mx-auto my-4 w-full sm:w-4/5 md:w-4/5 lg:w-3/4">

            {{-- Back Button --}}
            {{-- <div class="absolute top-16 left-0 m-4 z-10">
                <a href="{{ url()->previous() }}">
            ...
            <div class="p-6">
                <div class="py-4 mt-4 whitespace-normal break-words">
                    {!! nl2br(app('htmlpurifier')->purify($post->content)) !!}
                </div>
            </div>
        </div>
    </div>
